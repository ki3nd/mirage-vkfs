...
async def test_search_command_resolves_globs_and_passes_multiple_documents(
        monkeypatch):
    from mirage_vkfs.commands.builtin.dify import search as command_search
    from mirage_vkfs.core.dify import search, tree
...
async def test_search_command_root_searches_whole_dataset(monkeypatch):
    from mirage_vkfs.commands.builtin.dify import search as command_search
    from mirage_vkfs.core.dify import search
